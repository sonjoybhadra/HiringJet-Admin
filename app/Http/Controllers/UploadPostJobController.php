                            ...
                            for($k=0;$k<count($rows);$k++){
                                ...
                                if($k > 0){
                                    ...
                                    $fields = [
                                        ...
                                        'application_through'       => strip_tags($Application_Through ?: null),
                                        'apply_on_email'            => strip_tags($Apply_on_email ?: null),
                                        'apply_on_link'             => strip_tags($Apply_on_link ?: null),
                                        'walkin_address1'           => strip_tags($Walkin_address_1 ?: null),
                                        'walkin_address2'           => strip_tags($Walkin_address_2 ?: null),
                                        'walkin_country'            => strip_tags($Walkin_Country ?: null),
                                        'walkin_state'              => strip_tags($Walkin_State ?: null),
                                        'walkin_city'               => strip_tags($Walkin_City ?: null),
                                        'walkin_pincode'            => strip_tags($Walkin_Pincode ?: null),
                                        'walkin_latitude'           => strip_tags($Walkin_Latitude ?: null),
                                        'walkin_longitude'          => strip_tags($Walkin_Longitude ?: null),
