...
class TicketPriorityController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data = array(
            ...
            'controller_route'  => 'ticket-priority',
            'primary_key'       => 'id',
        );
    }
    /* list */
        public function list(){
            ...
            $page_name                      = 'ticket-priority.list';
    ...
    /* add */
        public function add(Request $request){
            ...
            $page_name                      = 'ticket-priority.add-edit';
            $data['row']                    = [];
            $data                           = $this->siteAuthService ->admin_after_login_layout($title,$page_name,$data);
            return view('maincontents.' . $page_name, $data);
        }
    ...
    /* edit */
        public function edit(Request $request, $id){
            ...
            $page_name                      = 'ticket-priority.add-edit';
            $data['row']                    = TicketPriority::where($this->data['primary_key'], '=', $id)->first();
            ...
            if($request->isMethod('post')){
                ...
                if($this->validate($request, $rules)){
                    ...
                    TicketPriority::where($this->data['primary_key'], '=', $id)->update($fields);
                    /* user activity */
                        $activityData = [
                            'user_email'        => session('user_data')['email'],
                            'user_name'         => session('user_data')['name'],
