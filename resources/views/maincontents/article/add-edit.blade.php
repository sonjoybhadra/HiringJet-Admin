         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label for="ckeditor1" class="form-label">Article Content <small class="text-danger">*</small></label>
                            <textarea class="form-control" id="ckeditor1" name="page_content" placeholder="Article Content"><?=$page_content?></textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="d-flex align-items-start align-items-sm-center gap-4 mt-3">
                                <div class="button-wrapper">
                                    <label for="page_banner_image" class="btn btn-primary me-2 mb-4" tabindex="0">
                                        <span class="d-none d-sm-block">Upload Article Banner Image</span>
                            ...
                            <div class="d-flex align-items-start align-items-sm-center gap-4 mt-3">
                                <div class="button-wrapper">
                                    <label for="page_image" class="btn btn-primary me-2 mb-4" tabindex="0">
                                        <span class="d-none d-sm-block">Upload Article Image</span>
                                        <i class="bx bx-upload d-block d-sm-none"></i>
