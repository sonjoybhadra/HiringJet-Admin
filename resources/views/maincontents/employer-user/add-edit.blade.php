                    ...
                    <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select class="form-select custom-dropdown" type="text" id="country_code" name="country_code" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select custom-dropdown" type="text" id="business_id" name="business_id" required>
                                    <option value="" selected>Select Business Name</option>
                                    <?php if ($business) {
                                        foreach ($business as $bzn) { ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select custom-dropdown" type="text" id="designation_id" name="designation_id" required>
