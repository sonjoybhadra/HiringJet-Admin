            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'contact_us',
                  'columns' => ['name', 'email', 'phone', 'city_id', 'organization', 'interested_in', 'created_at'],
                  'visibleColumns' => ['name', 'email', 'phone', 'city_name', 'organization', 'interested_in', 'created_at'],
                  'headers' => ['#', 'Name', 'Email', 'Phone', 'City', 'Organization', 'Interested In', 'Created At'],
                  'filename' => "Contact_Us",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
