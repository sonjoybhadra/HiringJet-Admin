            ...
            <div class="card-body">
                <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <img src="<?=(($user_image != '')?config('constants.app_url') . config('constants.uploads_url_path') . $user_image:config('constants.no_image'))?>" alt="<?=$title?>" class="img-thumbnail mt-3" height="200" width="200" id="uploadedAvatar" />
                        </div>
                    </div>
                    <div class="mt-2">
