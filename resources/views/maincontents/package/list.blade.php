            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'packages',
                  'columns' => ['name', 'price', 'cv_storage_limit', 'users', 'features', 'ideal_for', 'created_at', 'status'],
                  'visibleColumns' => ['name', 'price', 'cv_storage_limit', 'users', 'features', 'ideal_for', 'created_at'],    // used for rendering
                  'headers' => ['#', 'Name', 'Price', 'CV Storage Limit', 'No. Of Users', 'Features', 'Ideal For', 'Created At'],
                  'filename' => "Package",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
