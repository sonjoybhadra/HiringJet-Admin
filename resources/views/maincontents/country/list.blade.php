            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'countries',
                  'columns' => ['name', 'country_code', 'country_flag', 'created_at', 'status'],
                  'visibleColumns' => ['name', 'country_code', 'country_flag', 'created_at'],    // used for rendering
                  'headers' => ['#', 'Name', 'Country ISD Code', 'Country Flag', 'Created At', 'Actions'],
                  'filename' => "Country",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
