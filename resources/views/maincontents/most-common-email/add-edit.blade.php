   ...
   <div class="row g-6">
      ...
      <div class="nav-align-top mb-4">
         ...
         <div class="card mb-4">
            <?php
            if($row){
                $emailid_domain             = $row->emailid_domain;
                $status                     = $row->status;
            } else {
                $emailid_domain             = '';
                $status                     = '';
            ...
            <div class="card-body">
                <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="emailid_domain" class="form-label">Email ID Domain <small class="text-danger">*</small></label>
                            <input class="form-control" type="text" id="emailid_domain" name="emailid_domain" value="<?=$emailid_domain?>" required placeholder="Email ID Domain" autofocus />
                        </div>
                        <div class="col-md-6">
