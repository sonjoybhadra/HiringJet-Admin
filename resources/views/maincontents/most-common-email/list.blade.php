      ...
      <div class="nav-align-top mb-4">
         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                'containerId' => 'table1',
                'searchId' => 'search1',
                'table' => 'most_common_emails',
                'columns' => ['emailid_domain', 'created_at', 'status'],
                'visibleColumns' => ['emailid_domain', 'created_at'],    // used for rendering
                'headers' => ['#', 'Email ID Domain', 'Created At', 'Actions'],
                'filename' => "Most_Common_Email",
                'orderBy' => 'id',
                'orderType' => 'desc',
                'conditions' => [
                    ['column' => 'status', 'operator' => '!=', 'value' => 3]
                ],
                'routePrefix' => 'most-common-email',
