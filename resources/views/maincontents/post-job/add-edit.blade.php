                                            ...
                                            <div class="row g-6 mt-3" id="step1">
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="employer_id" name="employer_id" required>
                                                        <option label="" value="" selected disabled>Select an option</option>
                                                        <?php if ($employers) {
                                                            foreach ($employers as $select_row) { ?>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="industry" name="industry" required>
                                                        <option label="" value="" selected disabled>Select an option</option>
                                                        <?php if ($industries) {
                                                            foreach ($industries as $select_row) { ?>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="nationality" name="nationality" required>
                                                        ...
                                                        <?php if ($nationalities) {
                                                            foreach ($nationalities as $select_row) { ?>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="contract_type" name="contract_type" required>
                                                        ...
                                                        <?php if ($contract_types) {
                                                            foreach ($contract_types as $select_row) { ?>
                                            ...
                                            <?php }
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="functional_area" name="functional_area">
                                                        ...
                                                        <?php if ($functionalareas) {
                                                            foreach ($functionalareas as $select_row) { ?>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    ...
                                                    <select class="select2" id="skill_ids" name="skill_ids[]" required multiple>
                                                        <?php if ($keyskills) {
                                                            foreach ($keyskills as $select_row) { ?>
...
<script>
    let input = document.getElementById("apply_on_email");
    let input2 = document.getElementById("apply_on_link");
    ...
    input.addEventListener("input", function() {
        this.value = this.value.replace(/\s/g, ""); // Remove spaces if pasted
    });
