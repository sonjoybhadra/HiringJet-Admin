            ...
            <div class="card-body">
                <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="percentage" class="form-label">Percentage(%) <small class="text-danger">*</small></label>
                            <input class="form-control" type="text" id="percentage" name="percentage" value="<?=$percentage?>" required placeholder="Percentage(%)" autofocus />
                        </div>
                        <div class="col-md-4">
