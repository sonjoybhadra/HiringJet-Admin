         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                'containerId' => 'table1',
                'searchId' => 'search1',
                'table' => 'profile_completes',
                'columns' => ['name', 'percentage', 'created_at', 'status'],
                'visibleColumns' => ['name', 'percentage', 'created_at'],    // used for rendering
                'headers' => ['#', 'Name', 'Percentage(%)', 'Created At', 'Actions'],
                'filename' => "Profile_Complete",
                'orderBy' => 'id',
                'orderType' => 'desc',
                'conditions' => [
                    ['column' => 'status', 'operator' => '!=', 'value' => 3]
                ],
                'routePrefix' => 'profile-complete',
