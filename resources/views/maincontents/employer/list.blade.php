            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'employers',
                  'columns' => ['name', 'no_of_employee', 'industry_id', 'created_by', 'created_at', 'status'],
                  'visibleColumns' => ['name', 'no_of_employee', 'industry_name', 'created_by_user', 'created_at'],    // used for rendering
                  'headers' => ['#', 'Name', 'No. Of Employee', 'Industry', 'Created By', 'Created At'],
                  'filename' => "Employer",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
