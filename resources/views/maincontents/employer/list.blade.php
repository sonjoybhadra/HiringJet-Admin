            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'employers',
                  'columns' => ['name', 'description', 'no_of_employee', 'industry_id', 'logo', 'created_by', 'created_at', 'employers.status'],
                  'visibleColumns' => ['name', 'description', 'no_of_employee', 'industry_name', 'logo', 'created_by_user', 'created_at'],    // used for rendering
                  'headers' => ['#', 'Name', 'Description', 'No. Of Employee', 'Industry', 'Logo', 'Created By', 'Created At'],
                  'filename' => "Employer",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
